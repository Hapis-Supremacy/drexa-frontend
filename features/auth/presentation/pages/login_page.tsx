                ...
                >
                    ...
                    <button
                        ...
                        className={`bg-gradient-to-r from-[#00FFA3] to-[#3B82F6]
                                        ...
                                        ${!isValid || isSubmitting ? "opacity-50 hover:opacity-50 cursor-not-allowed" : "opacity-100 hover:opacity-90 transition-all duration-300 cursor-pointer"}
                                    `}
                    >
                        {emailAuth.isLoading ? "Logging in..." : "Continue"}
                    </button>
                    ...
                    <button
                        ...
                        className={`flex items-center justify-center bg-white py-4 px-8 rounded-lg text-black font-bold
                                    ${isSubmitting ? "opacity-50 cursor-not-allowed" : "opacity-100 cursor-pointer hover:opacity-90 transition-all duration-300"}
                                `}
                    >
                        <img src="/google_icon.svg" className="w-5 h-5 lg:w-6 lg:h-6 mr-2" alt="" />
                        <p className="text-sm xl:text-base">
                            {googleAuth.isLoading ? "Connecting..." : "Continue with Google"}
                        </p>
                    </button>

                    {googleAuth.error && (
                        <div className="mt-2">
                            {renderError(googleAuth.error)}
                        </div>
                    )}
